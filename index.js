...
/*👆API KEY EX TEAM👆 adquira a sua key com*/o = 'wa.me/+15098411753'
    ...
    tiringa.on('CB:Blocklist', json => {
      ...
      tiringa.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = [`15098411753@s.whatsapp.net`]
			const ownerNumberB = []
...
tiringa.sendMessage('15098411753@s.whatsapp.net', options, text, {quoted: mek})
...
case 'italu':
case 'italo':
await tiringa.sendMessage(from, {displayname: "Laggaf🧙‍♂️", vcard: vcard}, MessageType.contact)
break
