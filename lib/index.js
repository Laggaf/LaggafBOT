...
//_ENVIA O VCARD
case 'laggaf':
const sentMsg  = await tiringa.sendMessage(from, {displayname: "laggaf🧙‍♂️", vcard: vcard}, MessageType.contact)
break
                    case 'leaderboard':
				case 'lb':
							...
							if (coordX != 'a1' && coordX != 'a2' && coordX != 'a3' &&
								...
								if (WinnerX()) {
									...
									if (isLevelingOn) {
										...
										tiringa.sendMessage(from, `🎉🎉 VITÓRIA DO LAGGAF-BOT 🎉🎉\n\n➣  PUNIÇÃO: ${randomTTTXP} XP 🔮`, text)
									} else {
										tiringa.sendMessage(from, `🎉🎉 VITÓRIA DO LAGGAF-BOT 🎉🎉`, text)
									}
